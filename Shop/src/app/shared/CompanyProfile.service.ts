...
import { CompanyProfile } from 'src/app/shared/CompanyProfile.model';
@Injectable({
    providedIn: 'root'
})
export class CompanyProfileService {
    list: CompanyProfile[] | undefined;
    formData!: CompanyProfile;
    aPIURL: string = environment.APIURL;
    controller: string = "CompanyProfile";
    ...
    SaveAsync(formData: CompanyProfile) {        
