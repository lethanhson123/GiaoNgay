...
export class OrderDeliveryDetailService {
    list: OrderDeliveryDetail[] | undefined;
    formData!: OrderDeliveryDetail;
    aPIURL: string = environment.APIURL;
    controller: string = "OrderDeliveryDetail";
    ...
    Save(formData: OrderDeliveryDetail) {        
    ...
    SaveAsync(formData: OrderDeliveryDetail) {        
    ...
    AddEmptyAsync(parentID: number) {
        let url = this.aPIURL + this.controller + '/AddEmptyAsync';
        const uploadData = JSON.stringify(parentID);
        const formUpload: FormData = new FormData();
        formUpload.append('data', uploadData);
        return this.httpClient.post(url, formUpload);
