...
import { OrderShipperDetail } from 'src/app/shared/OrderShipperDetail.model';
@Injectable({
    providedIn: 'root'
})
export class OrderShipperDetailService {
    list: OrderShipperDetail[] | undefined;
    formData!: OrderShipperDetail;
    aPIURL: string = environment.APIURL;
    controller: string = "OrderShipperDetail";
    ...
    Save(formData: OrderShipperDetail) {        
    ...
    SaveAsync(formData: OrderShipperDetail) {        
