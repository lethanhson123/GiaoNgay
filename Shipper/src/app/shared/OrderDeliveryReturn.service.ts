...
export class OrderDeliveryReturnService {
    list: OrderDeliveryReturn[] | undefined;
    formData!: OrderDeliveryReturn;
    aPIURL: string = environment.APIURL;
    controller: string = "OrderDeliveryReturn";
    ...
    Save(formData: OrderDeliveryReturn) {        
    ...
    SaveAsync(formData: OrderDeliveryReturn) {        
