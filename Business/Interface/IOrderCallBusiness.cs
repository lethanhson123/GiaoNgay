namespace Business.Interface
{
	public interface IOrderCallBusiness : IBaseBusiness<OrderCall>
	{
        ...
        Task<List<OrderCall>> GetByMembershipIDAndDateTimeEndAndSearchStringToLisAsync(long membershipID, DateTime dateTimeBegin, DateTime dateTimeEnd, string searchString);
