...
export class OrderDeliveryPaymentHistoryService {
    list: OrderDeliveryPaymentHistory[] | undefined;
    formData!: OrderDeliveryPaymentHistory;
    aPIURL: string = environment.APIURL;
    controller: string = "OrderDeliveryPaymentHistory";
    ...
    Save(formData: OrderDeliveryPaymentHistory) {        
    ...
    SaveAsync(formData: OrderDeliveryPaymentHistory) {        
