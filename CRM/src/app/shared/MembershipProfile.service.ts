...
import { MembershipProfile } from 'src/app/shared/MembershipProfile.model';
@Injectable({
    providedIn: 'root'
})
export class MembershipProfileService {
    list: MembershipProfile[] | undefined;
    formData!: MembershipProfile;
    aPIURL: string = environment.APIURL;
    controller: string = "MembershipProfile";
    ...
    Save(formData: MembershipProfile) {        
    ...
    SaveAsync(formData: MembershipProfile) {        
