...
import { StreetWard } from 'src/app/shared/StreetWard.model';
@Injectable({
    providedIn: 'root'
})
export class StreetWardService {
    list: StreetWard[] | undefined;
    formData!: StreetWard;
    aPIURL: string = environment.APIURL;
    controller: string = "StreetWard";
