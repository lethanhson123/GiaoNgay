...
export class CategoryMembershipService {
    list: CategoryMembership[] | undefined;
    formData!: CategoryMembership;
    aPIURL: string = environment.APIURL;
    controller: string = "CategoryMembership";
    ...
    Save(formData: CategoryMembership) {        
    ...
    SaveAsync(formData: CategoryMembership) {        
