...
export class OrderDeliveryHistoryService {
    list: OrderDeliveryHistory[] | undefined;
    formData!: OrderDeliveryHistory;
    aPIURL: string = environment.APIURL;
    controller: string = "OrderDeliveryHistory";
    ...
    Save(formData: OrderDeliveryHistory) {        
    ...
    SaveAsync(formData: OrderDeliveryHistory) {        
