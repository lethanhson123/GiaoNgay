...
namespace Helper
{
    public class Ean13
    {
        ...
        public static Barcode CreateBarcode(string path)
        {
            ...
            if (string.IsNullOrEmpty(model.Code))
            {
                ...
                model.Code = DateTime.Now.ToString("yyyyMMdd") + random.Next(1000000000).ToString();
                equals = true;
            }
            Ean13 ean13 = new Ean13();
            ean13.CountryCode = model.Code.Substring(0, 2);
            ean13.ManufacturerCode = model.Code.Substring(2, 6);
            ean13.ProductCode = model.Code.Substring(8, 4);
            ean13.Scale = 8;
            System.Drawing.Bitmap bmp = ean13.CreateBitmap();
            model.Description = ean13.CountryCode + ean13.ManufacturerCode + ean13.ProductCode + ean13.ChecksumDigit;
            string fileName = model.Description + ".png";
